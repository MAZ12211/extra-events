...
class SouthMRKMixSongScript extends Song {
    ...
    function startFunnyCutscene() {
        ...
        meanWhileBG = FunkinSprite.create(0, 0, "gameplay/songs/ee-south-mrk-mix/meanWhileBG");
        ...
        FunkinSound.playOnce(Paths.sound('gameplay/songs/ee-south-mrk-mix/meanWhile'), 1.0, function() {
            new FlxTimer().start(0.5, function(tmr) {
                PlayState.instance.remove(meanWhileBG);

                FunkinSound.playOnce(Paths.sound('gameplay/songs/ee-south-mrk-mix/bopeebo-hey'), 1.0);
